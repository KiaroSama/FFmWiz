...
Pointer interaction -- hit-testing, magnetic snapping and the drag/wheel
handlers -- moved on to `gui_editor_unified_timeline_input` when this file
in turn passed 1000 lines. What is left is the widget's state, geometry and
painting.
"""
from __future__ import annotations
from ffmwiz.gui import gui_common  # noqa: F401
from ffmwiz.gui.gui_common import *  # noqa: F401,F403
from ffmwiz.gui.classic.gui_editor_unified_timeline_input import (
    build_unified_timeline_input_mixin)
...
def build_unified_timeline_widget():
    ...
    InputMixin = build_unified_timeline_input_mixin()

    class UnifiedTimelineWidget(InputMixin, QWidget):
