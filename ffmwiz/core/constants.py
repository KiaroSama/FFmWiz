...
# The pure-data tables below live in leaf siblings so this module stays
# scannable and under 800 lines. Imported here, before the definitions
# that union or splice them, so every later reference resolves.
from ffmwiz.core.constants_codecs import *  # noqa: E402,F401,F403
from ffmwiz.core.constants_extensions import *  # noqa: E402,F401,F403
from ffmwiz.core.constants_look import *  # noqa: E402,F401,F403
from ffmwiz.core.constants_composite import *  # noqa: E402,F401,F403

# Derived, so it stays with its inputs rather than in the extensions leaf:
# it unions the two literal sets above with the two format lists defined
# earlier in this module.
FOLDER_MEDIA_EXTS = (FOLDER_VIDEO_EXTS | AUDIO_ONLY_EXTS
                     | set(COMMON_VIDEO_FORMATS) | set(COMMON_AUDIO_FORMATS))
