...
# L02_encoder_policy holds the how-to-encode decisions -- CPU two-pass and
# the CUDA fast path -- split off when this file reached the size ceiling.
# Same double binding and the same one-way direction as below.
from ffmwiz.support import L02_encoder_policy as _L02_encoder_policy  # noqa: E402
from ffmwiz.support import L02_encoder_policy  # noqa: E402,F401
from ffmwiz.support.L02_encoder_policy import *  # noqa: E402,F401,F403
__all__ = list(__all__) + list(_L02_encoder_policy.__all__)
